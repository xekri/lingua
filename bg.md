...
<br>реформа на българскийа правопис
...
- {`а`, `я`} reads as {`ъ`, `йъ`} → {`ѫ`, `йѫ`}

| current               | new         |
| :-------------------- | :---------- |
| (аз) чета, (те) четат | четѫ, четѫт |
| (аз) пея, (те) пеят   | пейѫ, пейѫт |
...
ВСЕОБЩА ДЕКЛАРАЦИЙА ЗА ПРАВАТА НА ЧОВЕКА
<br>Член 1
<br>Всички хора се рађѫт свободни и равни по достойнство и права.
<br>Те сѫ надарени с разум и съвест и следвѫ да се отнасйѫт помеђу си в дух на братство.
