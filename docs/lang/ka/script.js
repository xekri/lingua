...
document.addEventListener("DOMContentLoaded", () => {
  ...
  for (const e of document.getElementsByClassName("ka")) e.innerHTML = `${convert[1](e.innerHTML)} (${e.innerHTML})`;
});
const table = [["კ", "k'"], ["პ", "p'"], ["წ", "ŧ'"], ["ჭ", "ṭ'"], ["ტ", "t'"], ["ა", "a"], ["ბ", "b"], ["გ", "c"], ["დ", "d"], ["ე", "e"], ["ვ", "w"], ["ზ", "z"], ["თ", "t"], ["ი", "i"], ["ლ", "l"], ["მ", "m"], ["ნ", "n"], ["ო", "o"], ["ჟ", "ẓ"], ["რ", "r"], ["ს", "s"], ["უ", "u"], ["ფ", "p"], ["ქ", "k"], ["ღ", "g"], ["ყ", "q"], ["შ", "ṣ"], ["ჩ", "ṭ"], ["ც", "ŧ"], ["ძ", "đ"], ["ხ", "x"], ["ჯ", "ḍ"], ["ჰ", "h"], ["ჶ", "f"], ["ჴ", "q"]];
