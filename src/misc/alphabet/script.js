...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const f = () => {
    ...
    if (selStyle.value in styles) {
      ...
      if (selStyle.value == "serif-italic")
        s = s
          .replace(/ı/g, "𝚤")
          .replace(/ȷ/g, "𝚥")
      ...
      if (selStyle.value in zeroCodes)
        for (let i = 0; i < 10; i++)
          s = s.replace(new RegExp(i.toString(), "g"), stringFromCharCode(zeroCodes[selStyle.value] + i))
